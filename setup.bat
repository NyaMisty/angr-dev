...
Rem if not exist angr-doc git clone https://github.com/angr/angr-doc.git || goto :error
Rem if not exist binaries git clone https://github.com/angr/binaries.git || goto :error
